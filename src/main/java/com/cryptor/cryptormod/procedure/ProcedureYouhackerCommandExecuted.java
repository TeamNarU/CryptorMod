...
public class ProcedureYouhackerCommandExecuted extends ElementsCryptorMod.ModElement {
	public ProcedureYouhackerCommandExecuted(ElementsCryptorMod instance) {
		super(instance, 70);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (entity instanceof EntityPlayerMP) {
			Advancement _adv = ((MinecraftServer) ((EntityPlayerMP) entity).mcServer).getAdvancementManager()
					.getAdvancement(new ResourceLocation("cryptormod:easteregg1"));
