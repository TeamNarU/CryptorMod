...
public class EntityMerchant extends ElementsCryptorMod.ModElement {
	public static final int ENTITYID = 21;
	public static final int ENTITYID_RANGED = 22;
	public EntityMerchant(ElementsCryptorMod instance) {
		super(instance, 76);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("cryptormod", "merchant"), ENTITYID).name("merchant").tracker(64, 3, true).egg(-1, -256).build());
	}
