...
public class ItemCyberSword extends ElementsCryptorMod.ModElement {
	@GameRegistry.ObjectHolder("cryptormod:cybersword")
	public static final Item block = null;
	public ItemCyberSword(ElementsCryptorMod instance) {
		super(instance, 16);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("CYBERSWORD", 0, 100000, 4f, 360f, 2)) {
			@Override
		...
		}.setUnlocalizedName("cybersword").setRegistryName("cybersword").setCreativeTab(TabModTab.tab));
	}
