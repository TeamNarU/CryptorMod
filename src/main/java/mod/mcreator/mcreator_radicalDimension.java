...
public class mcreator_radicalDimension extends cryptormod.ModElement {

	public static final int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("cryptormod:radicaldimension")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("cryptormod:radicaldimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;

	public mcreator_radicalDimension(cryptormod instance) {
		super(instance);
		instance.blocks.add(() -> new BlockCustomPortal());
		instance.items.add(() -> new ItemBlock(portal).setRegistryName(portal.getRegistryName()));
		instance.items.add(() -> new ModTrigger().setUnlocalizedName("radicaldimension").setRegistryName("radicaldimension"));
		dtype = DimensionType.register("radicaldimension", "_radicaldimension", DIMID, WorldProviderMod.class, true);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("cryptormod:radicaldimension", "inventory"));
	}
					...
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							this.world.setBlockState(new BlockPos(i2, j2, k2),
									flag ? mcreator_cryptorBlock.block.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			...
			for (int i8 = 0; i8 < 4; ++i8) {
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? mcreator_cryptorBlock.block.getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		...
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("radicaldimension_portal");
			setRegistryName("radicaldimension_portal");
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != mcreator_cryptorBlock.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == mcreator_cryptorBlock.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != mcreator_cryptorBlock.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != mcreator_cryptorBlock.block
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {mcreator_radicalBiome.biome,};
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		protected static final IBlockState STONE = mcreator_radicalWorldBlock.block.getDefaultState();
		protected static final IBlockState GRAVEL = mcreator_radicalWorldBlock.block.getDefaultState();
		protected static final IBlockState WATER = mcreator_radicalWorldBlock.block.getDefaultState();
