...
public class mcreator_chickenDetonatorRightClickedOnBlock extends cryptormod.ModElement {

	public mcreator_chickenDetonatorRightClickedOnBlock(cryptormod instance) {
		super(instance);
	}
